...
try:
    ...
    BS4_OK = False
    logging.warning("bs4 не найден — парсинг внешних каналов отключён. Установи: pip install beautifulsoup4 lxml")

try:
    from lxml import etree  # noqa — просто проверяем наличие
except ImportError:
    pass
